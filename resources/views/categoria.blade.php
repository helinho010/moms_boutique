            ...
            <thead>
              ...
              <tbody>
                @foreach ($categorias as $categoria)
                  <tr>
                    <th scope="row">
                      <i class="fas fa-edit fa-xl i" id=""></i>
                      <i class="fas fa-trash-alt fa-xl i" id="{{ $categoria->id }}"></i>
                    </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('nueva_categoria') }}" id="nueva_categoria">
                        ...
                        @method('POST')
                        <div class="mb-3">
                          <label for="exampleInputEmail1" class="form-label">Nombre de la Categoria: {{ route('nueva_categoria') }}</label>
